...
export default function DocsPage() {
  return (
    <SiteShell current="Documentation">
      ...
      <p>Android: open Lemon Tracking, select <strong>Open Usage Access</strong>, enable access in system settings, return to the app and select <strong>Refresh today</strong>.</p>
      <h2>Local files</h2>
