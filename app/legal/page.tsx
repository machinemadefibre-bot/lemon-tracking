...
export default function LegalPage() {
  return (
    <SiteShell current="Legal Information">
      <section className="page-title"><p className="eyebrow">LEGAL INFORMATION</p><h1>Legal information</h1><div className="notice"><p><strong>Release 0.1.0</strong></p><p>The public site publishes the Lemon Tracking desktop collectors and local console documentation.</p><p>Local records use the application-data area of the device running each collector. Settings provides JSON and CSV export plus deletion for today, a selected date or all activity data.</p></div></section>
      ...
      <section className="doc-panel"><h2>Open source software</h2><p>Release 0.1.0 packages independent Windows, macOS and Linux collector implementations. ActivityWatch appears as an upstream reference for local-first tracking concepts and data boundaries.</p><p>See the current ActivityWatch project and applicable license notices at <a href="https://github.com/ActivityWatch/activitywatch">github.com/ActivityWatch</a>. Future releases that include ActivityWatch code or binaries will ship the corresponding source and MPL-2.0 notices.</p></section>
    </SiteShell>
  );
}
