...
export default function LegalPage() {
  return (
    <SiteShell current="Legal Information">
      ...
      <section className="doc-panel"><h2>Open source software</h2><p>Release 0.1.2 packages independent Windows, macOS, Linux and Android collector implementations. ActivityWatch appears as an upstream reference for local-first tracking concepts and data boundaries.</p><p>See the current ActivityWatch project and applicable license notices at <a href="https://github.com/ActivityWatch/activitywatch">github.com/ActivityWatch</a>. Future releases that include ActivityWatch code or binaries will ship the corresponding source and MPL-2.0 notices.</p></section>
    </SiteShell>
  );
}
