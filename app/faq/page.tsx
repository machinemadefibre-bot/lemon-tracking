...
const faqs = [
  ...
  ['Are there browser extension or iOS packages?', 'There is no browser extension or iOS package in the 0.1.1 release.'],
  ['Does the Windows package include ActivityWatch?', 'No. The 0.1.1 collector uses an independent implementation. ActivityWatch appears as an upstream reference in the legal information.'],
